...
In Qualtrics, the survey appeared as in Figure \@ref(fig:qualtrics-preview-global-trait).

```{r qualtrics-preview-global-trait, fig.cap="Preview of the first four items as they appeared in Qualtrics for the global trait form.", out.width="600px"}
knitr::include_graphics(rep("graphics/GlobalTraitPreview.png"))
```
