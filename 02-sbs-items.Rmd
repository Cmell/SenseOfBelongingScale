...
```{r qualtrics-preview-global-trait, fig.cap="Preview of the first four items as they appeared in Qualtrics for the global trait form. On the real survey, items were presented in a random order.", out.width="600px"}
